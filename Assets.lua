...
assets.productId = {
		Starter =  3605271320,               --// 15 R$
		TenBP = 3605271321,                 --// 10 R$
		FiftyBP = 3605271323,               --// 30 R$
		TwoHundredBP = 3605271325,          --// 75 R$
		TwoThousandBP = 3605271329,         --// 200 R$
		UMV1 =  3605271331,                  --// 5 R$
		UMV3 = 3605271335,                  --// 10 R$
		UMV6 = 3605271337,                  --// 15 R$
		_10kP  = 3605271340,                --// 10 R$
		_50kP  = 3605271342,                --// 40 R$
		_100kP = 3605271345,                --// 75 R$
		_200kP = 3605271349,                --// 120 R$
		PBSpins1 = 3605271355,              --// 5 R$
		PBSpins5 = 3605271359,              --// 20 R$
		PBSpins10 = 3605271365,             --// 30 R$
		AshGreninja = 3605271366,           --// 75 R$
	Hoverboard = 3605271371,            --// 10 R$
	MasterBall = 3605271377,            --// 10 R$
	RoPowers = {
		{3605271384, 3605271385},       --// 15 R$, 20 R$ (XP) 1-2
		{3605271386, 3605271388},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605271390, 3605271391},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605271398, 3605271400},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605271401},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605271403},                     --// 45 R$ (Legendaries) 11
		{3605271404}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605271355,
		PBSpins5 = 3605271359,
		PBSpins10 = 3605271365,
		AshGreninja = 3605271366,
		Hoverboard = 3605271371,
		MasterBall = 3605271377,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
