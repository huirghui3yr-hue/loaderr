...
assets.productId = {
		Starter =  3605280117,               --// 15 R$
		TenBP = 3605280122,                 --// 10 R$
		FiftyBP = 3605280125,               --// 30 R$
		TwoHundredBP = 3605280133,          --// 75 R$
		TwoThousandBP = 3605280138,         --// 200 R$
		UMV1 =  3605280143,                  --// 5 R$
		UMV3 = 3605280147,                  --// 10 R$
		UMV6 = 3605280151,                  --// 15 R$
		_10kP  = 3605280158,                --// 10 R$
		_50kP  = 3605280161,                --// 40 R$
		_100kP = 3605280166,                --// 75 R$
		_200kP = 3605280172,                --// 120 R$
		PBSpins1 = 3605280176,              --// 5 R$
		PBSpins5 = 3605280179,              --// 20 R$
		PBSpins10 = 3605280183,             --// 30 R$
		AshGreninja = 3605280188,           --// 75 R$
	Hoverboard = 3605280193,            --// 10 R$
	MasterBall = 3605280195,            --// 10 R$
	RoPowers = {
		{3605280199, 3605280200},       --// 15 R$, 20 R$ (XP) 1-2
		{3605280206, 3605280214},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605280219, 3605280223},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605280228, 3605280231},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605280237},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605280240},                     --// 45 R$ (Legendaries) 11
		{3605280245}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605280176,
		PBSpins5 = 3605280179,
		PBSpins10 = 3605280183,
		AshGreninja = 3605280188,
		Hoverboard = 3605280193,
		MasterBall = 3605280195,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
