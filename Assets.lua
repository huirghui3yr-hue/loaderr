...
assets.productId = {
		Starter =  3605263721,               --// 15 R$
		TenBP = 3605263729,                 --// 10 R$
		FiftyBP = 3605263733,               --// 30 R$
		TwoHundredBP = 3605263735,          --// 75 R$
		TwoThousandBP = 3605263739,         --// 200 R$
		UMV1 =  3605263741,                  --// 5 R$
		UMV3 = 3605263743,                  --// 10 R$
		UMV6 = 3605263744,                  --// 15 R$
		_10kP  = 3605263746,                --// 10 R$
		_50kP  = 3605263751,                --// 40 R$
		_100kP = 3605263752,                --// 75 R$
		_200kP = 3605263756,                --// 120 R$
		PBSpins1 = 3605263758,              --// 5 R$
		PBSpins5 = 3605263761,              --// 20 R$
		PBSpins10 = 3605263763,             --// 30 R$
		AshGreninja = 3605263764,           --// 75 R$
	Hoverboard = 3605263768,            --// 10 R$
	MasterBall = 3605263772,            --// 10 R$
	RoPowers = {
		{3605263774, 3605263778},       --// 15 R$, 20 R$ (XP) 1-2
		{3605263780, 3605263781},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605263786, 3605263792},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605263796, 3605263800},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605263807},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605263811},                     --// 45 R$ (Legendaries) 11
		{3605263817}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605263758,
		PBSpins5 = 3605263761,
		PBSpins10 = 3605263763,
		AshGreninja = 3605263764,
		Hoverboard = 3605263768,
		MasterBall = 3605263772,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
