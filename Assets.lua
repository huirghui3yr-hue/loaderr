...
assets.productId = {
		Starter =  3605262308,               --// 15 R$
		TenBP = 3605262312,                 --// 10 R$
		FiftyBP = 3605262318,               --// 30 R$
		TwoHundredBP = 3605262325,          --// 75 R$
		TwoThousandBP = 3605262329,         --// 200 R$
		UMV1 =  3605262332,                  --// 5 R$
		UMV3 = 3605262334,                  --// 10 R$
		UMV6 = 3605262338,                  --// 15 R$
		_10kP  = 3605262342,                --// 10 R$
		_50kP  = 3605262344,                --// 40 R$
		_100kP = 3605262348,                --// 75 R$
		_200kP = 3605262354,                --// 120 R$
		PBSpins1 = 3605262358,              --// 5 R$
		PBSpins5 = 3605262363,              --// 20 R$
		PBSpins10 = 3605262370,             --// 30 R$
		AshGreninja = 3605262373,           --// 75 R$
	Hoverboard = 3605262381,            --// 10 R$
	MasterBall = 3605262386,            --// 10 R$
	RoPowers = {
		{3605262391, 3605262395},       --// 15 R$, 20 R$ (XP) 1-2
		{3605262399, 3605262402},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605262404, 3605262406},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605262410, 3605262415},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605262419},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605262423},                     --// 45 R$ (Legendaries) 11
		{3605262426}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605262358,
		PBSpins5 = 3605262363,
		PBSpins10 = 3605262370,
		AshGreninja = 3605262373,
		Hoverboard = 3605262381,
		MasterBall = 3605262386,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
