...
assets.productId = {
		Starter =  3605210950,               --// 15 R$
		TenBP = 3605210952,                 --// 10 R$
		FiftyBP = 3605210954,               --// 30 R$
		TwoHundredBP = 3605210957,          --// 75 R$
		TwoThousandBP = 3605210958,         --// 200 R$
		UMV1 =  3605210962,                  --// 5 R$
		UMV3 = 3605210965,                  --// 10 R$
		UMV6 = 3605210968,                  --// 15 R$
		_10kP  = 3605210970,                --// 10 R$
		_50kP  = 3605210973,                --// 40 R$
		_100kP = 3605210975,                --// 75 R$
		_200kP = 3605210978,                --// 120 R$
		PBSpins1 = 3605210992,              --// 5 R$
		PBSpins5 = 3605210995,              --// 20 R$
		PBSpins10 = 3605210997,             --// 30 R$
		AshGreninja = 3605211001,           --// 75 R$
	Hoverboard = 3605211006,            --// 10 R$
	MasterBall = 3605211010,            --// 10 R$
	RoPowers = {
		{3605211013, 3605211017},       --// 15 R$, 20 R$ (XP) 1-2
		{3605211021, 3605211026},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605211027, 3605211030},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605211034, 3605211037},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605211040},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605211042},                     --// 45 R$ (Legendaries) 11
		{3605211043}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
