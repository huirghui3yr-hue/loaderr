...
assets.productId = {
		Starter =  3605267231,               --// 15 R$
		TenBP = 3605267234,                 --// 10 R$
		FiftyBP = 3605267239,               --// 30 R$
		TwoHundredBP = 3605267242,          --// 75 R$
		TwoThousandBP = 3605267245,         --// 200 R$
		UMV1 =  3605267250,                  --// 5 R$
		UMV3 = 3605267252,                  --// 10 R$
		UMV6 = 3605267254,                  --// 15 R$
		_10kP  = 3605267257,                --// 10 R$
		_50kP  = 3605267259,                --// 40 R$
		_100kP = 3605267261,                --// 75 R$
		_200kP = 3605267263,                --// 120 R$
		PBSpins1 = 3605267268,              --// 5 R$
		PBSpins5 = 3605267271,              --// 20 R$
		PBSpins10 = 3605267274,             --// 30 R$
		AshGreninja = 3605267278,           --// 75 R$
	Hoverboard = 3605267280,            --// 10 R$
	MasterBall = 3605267282,            --// 10 R$
	RoPowers = {
		{3605267285, 3605267290},       --// 15 R$, 20 R$ (XP) 1-2
		{3605267297, 3605267301},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605267305, 3605267309},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605267311, 3605267315},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605267316},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605267323},                     --// 45 R$ (Legendaries) 11
		{3605267325}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605267268,
		PBSpins5 = 3605267271,
		PBSpins10 = 3605267274,
		AshGreninja = 3605267278,
		Hoverboard = 3605267280,
		MasterBall = 3605267282,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
