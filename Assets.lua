...
assets.productId = {
		Starter =  3605263417,               --// 15 R$
		TenBP = 3605263421,                 --// 10 R$
		FiftyBP = 3605263424,               --// 30 R$
		TwoHundredBP = 3605263425,          --// 75 R$
		TwoThousandBP = 3605263427,         --// 200 R$
		UMV1 =  3605263432,                  --// 5 R$
		UMV3 = 3605263436,                  --// 10 R$
		UMV6 = 3605263441,                  --// 15 R$
		_10kP  = 3605263446,                --// 10 R$
		_50kP  = 3605263450,                --// 40 R$
		_100kP = 3605263454,                --// 75 R$
		_200kP = 3605263459,                --// 120 R$
		PBSpins1 = 3605263463,              --// 5 R$
		PBSpins5 = 3605263466,              --// 20 R$
		PBSpins10 = 3605263468,             --// 30 R$
		AshGreninja = 3605263471,           --// 75 R$
	Hoverboard = 3605263474,            --// 10 R$
	MasterBall = 3605263478,            --// 10 R$
	RoPowers = {
		{3605263480, 3605263484},       --// 15 R$, 20 R$ (XP) 1-2
		{3605263487, 3605263489},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605263490, 3605263493},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605263495, 3605263497},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605263500},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605263502},                     --// 45 R$ (Legendaries) 11
		{3605263504}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605263463,
		PBSpins5 = 3605263466,
		PBSpins10 = 3605263468,
		AshGreninja = 3605263471,
		Hoverboard = 3605263474,
		MasterBall = 3605263478,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
