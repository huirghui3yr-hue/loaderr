...
assets.productId = {
		Starter =  3605270586,               --// 15 R$
		TenBP = 3605270591,                 --// 10 R$
		FiftyBP = 3605270593,               --// 30 R$
		TwoHundredBP = 3605270601,          --// 75 R$
		TwoThousandBP = 3605270606,         --// 200 R$
		UMV1 =  3605270609,                  --// 5 R$
		UMV3 = 3605270613,                  --// 10 R$
		UMV6 = 3605270618,                  --// 15 R$
		_10kP  = 3605270621,                --// 10 R$
		_50kP  = 3605270627,                --// 40 R$
		_100kP = 3605270629,                --// 75 R$
		_200kP = 3605270631,                --// 120 R$
		PBSpins1 = 3605270634,              --// 5 R$
		PBSpins5 = 3605270638,              --// 20 R$
		PBSpins10 = 3605270640,             --// 30 R$
		AshGreninja = 3605270643,           --// 75 R$
	Hoverboard = 3605270649,            --// 10 R$
	MasterBall = 3605270652,            --// 10 R$
	RoPowers = {
		{3605270657, 3605270664},       --// 15 R$, 20 R$ (XP) 1-2
		{3605270667, 3605270670},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605270674, 3605270677},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605270682, 3605270687},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605270690},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605270695},                     --// 45 R$ (Legendaries) 11
		{3605270699}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605270634,
		PBSpins5 = 3605270638,
		PBSpins10 = 3605270640,
		AshGreninja = 3605270643,
		Hoverboard = 3605270649,
		MasterBall = 3605270652,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
