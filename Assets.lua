...
assets.productId = {
		Starter =  3605392963,               --// 15 R$
		TenBP = 3605392967,                 --// 10 R$
		FiftyBP = 3605392973,               --// 30 R$
		TwoHundredBP = 3605392978,          --// 75 R$
		TwoThousandBP = 3605392981,         --// 200 R$
		UMV1 =  3605392985,                  --// 5 R$
		UMV3 = 3605392991,                  --// 10 R$
		UMV6 = 3605393000,                  --// 15 R$
		_10kP  = 3605393003,                --// 10 R$
		_50kP  = 3605393007,                --// 40 R$
		_100kP = 3605393011,                --// 75 R$
		_200kP = 3605393016,                --// 120 R$
		PBSpins1 = 3605393024,              --// 5 R$
		PBSpins5 = 3605393030,              --// 20 R$
		PBSpins10 = 3605393033,             --// 30 R$
		AshGreninja = 3605393037,           --// 75 R$
	Hoverboard = 3605393039,            --// 10 R$
	MasterBall = 3605393044,            --// 10 R$
	RoPowers = {
		{3605393047, 3605393052},       --// 15 R$, 20 R$ (XP) 1-2
		{3605393057, 3605393065},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605393068, 3605393074},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605393078, 3605393081},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605393086},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605393090},                     --// 45 R$ (Legendaries) 11
		{3605393092}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605393024,
		PBSpins5 = 3605393030,
		PBSpins10 = 3605393033,
		AshGreninja = 3605393037,
		Hoverboard = 3605393039,
		MasterBall = 3605393044,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
