...
assets.productId = {
		Starter =  3605274711,               --// 15 R$
		TenBP = 3605274716,                 --// 10 R$
		FiftyBP = 3605274721,               --// 30 R$
		TwoHundredBP = 3605274723,          --// 75 R$
		TwoThousandBP = 3605274727,         --// 200 R$
		UMV1 =  3605274730,                  --// 5 R$
		UMV3 = 3605274733,                  --// 10 R$
		UMV6 = 3605274736,                  --// 15 R$
		_10kP  = 3605274739,                --// 10 R$
		_50kP  = 3605274741,                --// 40 R$
		_100kP = 3605274744,                --// 75 R$
		_200kP = 3605274745,                --// 120 R$
		PBSpins1 = 3605274747,              --// 5 R$
		PBSpins5 = 3605274749,              --// 20 R$
		PBSpins10 = 3605274753,             --// 30 R$
		AshGreninja = 3605274755,           --// 75 R$
	Hoverboard = 3605274759,            --// 10 R$
	MasterBall = 3605274763,            --// 10 R$
	RoPowers = {
		{3605274768, 3605274774},       --// 15 R$, 20 R$ (XP) 1-2
		{3605274776, 3605274782},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605274786, 3605274789},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605274791, 3605274793},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605274794},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605274798},                     --// 45 R$ (Legendaries) 11
		{3605274804}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605274747,
		PBSpins5 = 3605274749,
		PBSpins10 = 3605274753,
		AshGreninja = 3605274755,
		Hoverboard = 3605274759,
		MasterBall = 3605274763,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
