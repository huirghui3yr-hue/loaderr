...
assets.productId = {
		...
		UMV1 =  3605122733,                  --// 5 R$
		UMV3 = 3605122734,                  --// 10 R$
		UMV6 = 3605122739,                  --// 15 R$
		_10kP  = 3299078476,                --// 10 R$
		_50kP  = 3299078623,                --// 40 R$
		_100kP = 3299078733,                --// 75 R$
		_200kP = 3299078860,                --// 120 R$
		PBSpins1 = 3605122741,              --// 5 R$
		PBSpins5 = 3605122742,              --// 20 R$
		PBSpins10 = 3605122743,             --// 30 R$
		AshGreninja = 3295492131,           --// 75 R$
	Hoverboard = 3605122745,            --// 10 R$
	MasterBall = 3605122747,            --// 10 R$
	RoPowers = {
