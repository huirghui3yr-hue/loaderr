...
assets.productId = {
		Starter =  3605273876,               --// 15 R$
		TenBP = 3605273883,                 --// 10 R$
		FiftyBP = 3605273890,               --// 30 R$
		TwoHundredBP = 3605273894,          --// 75 R$
		TwoThousandBP = 3605273896,         --// 200 R$
		UMV1 =  3605273899,                  --// 5 R$
		UMV3 = 3605273900,                  --// 10 R$
		UMV6 = 3605273904,                  --// 15 R$
		_10kP  = 3605273905,                --// 10 R$
		_50kP  = 3605273911,                --// 40 R$
		_100kP = 3605273914,                --// 75 R$
		_200kP = 3605273918,                --// 120 R$
		PBSpins1 = 3605273924,              --// 5 R$
		PBSpins5 = 3605273926,              --// 20 R$
		PBSpins10 = 3605273930,             --// 30 R$
		AshGreninja = 3605273934,           --// 75 R$
	Hoverboard = 3605273937,            --// 10 R$
	MasterBall = 3605273940,            --// 10 R$
	RoPowers = {
		{3605273943, 3605273949},       --// 15 R$, 20 R$ (XP) 1-2
		{3605273951, 3605273954},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605273956, 3605273961},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605273964, 3605273968},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605273970},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605273976},                     --// 45 R$ (Legendaries) 11
		{3605273980}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605273924,
		PBSpins5 = 3605273926,
		PBSpins10 = 3605273930,
		AshGreninja = 3605273934,
		Hoverboard = 3605273937,
		MasterBall = 3605273940,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
