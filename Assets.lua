...
assets.productId = {
		Starter =  3605269089,               --// 15 R$
		TenBP = 3605269091,                 --// 10 R$
		FiftyBP = 3605269093,               --// 30 R$
		TwoHundredBP = 3605269097,          --// 75 R$
		TwoThousandBP = 3605269100,         --// 200 R$
		UMV1 =  3605269102,                  --// 5 R$
		UMV3 = 3605269108,                  --// 10 R$
		UMV6 = 3605269113,                  --// 15 R$
		_10kP  = 3605269117,                --// 10 R$
		_50kP  = 3605269120,                --// 40 R$
		_100kP = 3605269122,                --// 75 R$
		_200kP = 3605269126,                --// 120 R$
		PBSpins1 = 3605269128,              --// 5 R$
		PBSpins5 = 3605269132,              --// 20 R$
		PBSpins10 = 3605269135,             --// 30 R$
		AshGreninja = 3605269136,           --// 75 R$
	Hoverboard = 3605269140,            --// 10 R$
	MasterBall = 3605269143,            --// 10 R$
	RoPowers = {
		{3605269146, 3605269148},       --// 15 R$, 20 R$ (XP) 1-2
		{3605269152, 3605269157},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605269160, 3605269162},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605269164, 3605269168},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605269170},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605269172},                     --// 45 R$ (Legendaries) 11
		{3605269177}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605269128,
		PBSpins5 = 3605269132,
		PBSpins10 = 3605269135,
		AshGreninja = 3605269136,
		Hoverboard = 3605269140,
		MasterBall = 3605269143,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
