...
assets.productId = {
		Starter =  3605268520,               --// 15 R$
		TenBP = 3605268522,                 --// 10 R$
		FiftyBP = 3605268526,               --// 30 R$
		TwoHundredBP = 3605268531,          --// 75 R$
		TwoThousandBP = 3605268532,         --// 200 R$
		UMV1 =  3605268535,                  --// 5 R$
		UMV3 = 3605268540,                  --// 10 R$
		UMV6 = 3605268543,                  --// 15 R$
		_10kP  = 3605268552,                --// 10 R$
		_50kP  = 3605268556,                --// 40 R$
		_100kP = 3605268560,                --// 75 R$
		_200kP = 3605268565,                --// 120 R$
		PBSpins1 = 3605268566,              --// 5 R$
		PBSpins5 = 3605268570,              --// 20 R$
		PBSpins10 = 3605268573,             --// 30 R$
		AshGreninja = 3605268574,           --// 75 R$
	Hoverboard = 3605268580,            --// 10 R$
	MasterBall = 3605268584,            --// 10 R$
	RoPowers = {
		{3605268587, 3605268590},       --// 15 R$, 20 R$ (XP) 1-2
		{3605268593, 3605268598},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605268602, 3605268605},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605268608, 3605268613},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605268618},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605268624},                     --// 45 R$ (Legendaries) 11
		{3605268626}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605268566,
		PBSpins5 = 3605268570,
		PBSpins10 = 3605268573,
		AshGreninja = 3605268574,
		Hoverboard = 3605268580,
		MasterBall = 3605268584,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
