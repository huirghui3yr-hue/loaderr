...
assets.productId = {
		Starter =  3605265489,               --// 15 R$
		TenBP = 3605265492,                 --// 10 R$
		FiftyBP = 3605265497,               --// 30 R$
		TwoHundredBP = 3605265499,          --// 75 R$
		TwoThousandBP = 3605265503,         --// 200 R$
		UMV1 =  3605265506,                  --// 5 R$
		UMV3 = 3605265510,                  --// 10 R$
		UMV6 = 3605265514,                  --// 15 R$
		_10kP  = 3605265517,                --// 10 R$
		_50kP  = 3605265520,                --// 40 R$
		_100kP = 3605265525,                --// 75 R$
		_200kP = 3605265528,                --// 120 R$
		PBSpins1 = 3605265529,              --// 5 R$
		PBSpins5 = 3605265530,              --// 20 R$
		PBSpins10 = 3605265534,             --// 30 R$
		AshGreninja = 3605265535,           --// 75 R$
	Hoverboard = 3605265537,            --// 10 R$
	MasterBall = 3605265542,            --// 10 R$
	RoPowers = {
		{3605265546, 3605265556},       --// 15 R$, 20 R$ (XP) 1-2
		{3605265562, 3605265567},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605265570, 3605265573},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605265578, 3605265584},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605265586},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605265593},                     --// 45 R$ (Legendaries) 11
		{3605265597}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605265529,
		PBSpins5 = 3605265530,
		PBSpins10 = 3605265534,
		AshGreninja = 3605265535,
		Hoverboard = 3605265537,
		MasterBall = 3605265542,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
