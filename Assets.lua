...
assets.productId = {
		Starter =  3605390423,               --// 15 R$
		TenBP = 3605390425,                 --// 10 R$
		FiftyBP = 3605390430,               --// 30 R$
		TwoHundredBP = 3605390433,          --// 75 R$
		TwoThousandBP = 3605390437,         --// 200 R$
		UMV1 =  3605390441,                  --// 5 R$
		UMV3 = 3605390444,                  --// 10 R$
		UMV6 = 3605390448,                  --// 15 R$
		_10kP  = 3605390454,                --// 10 R$
		_50kP  = 3605390458,                --// 40 R$
		_100kP = 3605390461,                --// 75 R$
		_200kP = 3605390468,                --// 120 R$
		PBSpins1 = 3605390475,              --// 5 R$
		PBSpins5 = 3605390479,              --// 20 R$
		PBSpins10 = 3605390487,             --// 30 R$
		AshGreninja = 3605390490,           --// 75 R$
	Hoverboard = 3605390494,            --// 10 R$
	MasterBall = 3605390498,            --// 10 R$
	RoPowers = {
		{3605390500, 3605390507},       --// 15 R$, 20 R$ (XP) 1-2
		{3605390512, 3605390518},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605390520, 3605390523},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605390528, 3605390530},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605390535},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605390537},                     --// 45 R$ (Legendaries) 11
		{3605390540}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605390475,
		PBSpins5 = 3605390479,
		PBSpins10 = 3605390487,
		AshGreninja = 3605390490,
		Hoverboard = 3605390494,
		MasterBall = 3605390498,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
