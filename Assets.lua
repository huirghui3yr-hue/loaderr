...
assets.productId = {
		Starter =  3605272432,               --// 15 R$
		TenBP = 3605272435,                 --// 10 R$
		FiftyBP = 3605272437,               --// 30 R$
		TwoHundredBP = 3605272439,          --// 75 R$
		TwoThousandBP = 3605272444,         --// 200 R$
		UMV1 =  3605272446,                  --// 5 R$
		UMV3 = 3605272452,                  --// 10 R$
		UMV6 = 3605272456,                  --// 15 R$
		_10kP  = 3605272461,                --// 10 R$
		_50kP  = 3605272464,                --// 40 R$
		_100kP = 3605272469,                --// 75 R$
		_200kP = 3605272471,                --// 120 R$
		PBSpins1 = 3605272475,              --// 5 R$
		PBSpins5 = 3605272477,              --// 20 R$
		PBSpins10 = 3605272480,             --// 30 R$
		AshGreninja = 3605272482,           --// 75 R$
	Hoverboard = 3605272488,            --// 10 R$
	MasterBall = 3605272491,            --// 10 R$
	RoPowers = {
		{3605272495, 3605272498},       --// 15 R$, 20 R$ (XP) 1-2
		{3605272500, 3605272502},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605272503, 3605272506},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605272509, 3605272513},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605272519},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605272528},                     --// 45 R$ (Legendaries) 11
		{3605272536}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605272475,
		PBSpins5 = 3605272477,
		PBSpins10 = 3605272480,
		AshGreninja = 3605272482,
		Hoverboard = 3605272488,
		MasterBall = 3605272491,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
