...
assets.productId = {
		Starter =  3605289112,               --// 15 R$
		TenBP = 3605289116,                 --// 10 R$
		FiftyBP = 3605289124,               --// 30 R$
		TwoHundredBP = 3605289126,          --// 75 R$
		TwoThousandBP = 3605289130,         --// 200 R$
		UMV1 =  3605289132,                  --// 5 R$
		UMV3 = 3605289137,                  --// 10 R$
		UMV6 = 3605289144,                  --// 15 R$
		_10kP  = 3605289147,                --// 10 R$
		_50kP  = 3605289152,                --// 40 R$
		_100kP = 3605289158,                --// 75 R$
		_200kP = 3605289161,                --// 120 R$
		PBSpins1 = 3605289163,              --// 5 R$
		PBSpins5 = 3605289166,              --// 20 R$
		PBSpins10 = 3605289169,             --// 30 R$
		AshGreninja = 3605289175,           --// 75 R$
	Hoverboard = 3605289178,            --// 10 R$
	MasterBall = 3605289185,            --// 10 R$
	RoPowers = {
		{3605289189, 3605289193},       --// 15 R$, 20 R$ (XP) 1-2
		{3605289196, 3605289202},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605289205, 3605289208},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605289213, 3605289216},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605289222},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605289227},                     --// 45 R$ (Legendaries) 11
		{3605289233}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605289163,
		PBSpins5 = 3605289166,
		PBSpins10 = 3605289169,
		AshGreninja = 3605289175,
		Hoverboard = 3605289178,
		MasterBall = 3605289185,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
