...
assets.productId = {
		Starter =  3605288692,               --// 15 R$
		TenBP = 3605288697,                 --// 10 R$
		FiftyBP = 3605288701,               --// 30 R$
		TwoHundredBP = 3605288709,          --// 75 R$
		TwoThousandBP = 3605288712,         --// 200 R$
		UMV1 =  3605288717,                  --// 5 R$
		UMV3 = 3605288726,                  --// 10 R$
		UMV6 = 3605288731,                  --// 15 R$
		_10kP  = 3605288736,                --// 10 R$
		_50kP  = 3605288741,                --// 40 R$
		_100kP = 3605288743,                --// 75 R$
		_200kP = 3605288751,                --// 120 R$
		PBSpins1 = 3605288757,              --// 5 R$
		PBSpins5 = 3605288761,              --// 20 R$
		PBSpins10 = 3605288766,             --// 30 R$
		AshGreninja = 3605288769,           --// 75 R$
	Hoverboard = 3605288775,            --// 10 R$
	MasterBall = 3605288777,            --// 10 R$
	RoPowers = {
		{3605288779, 3605288788},       --// 15 R$, 20 R$ (XP) 1-2
		{3605288793, 3605288799},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605288805, 3605288810},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605288813, 3605288820},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605288822},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605288828},                     --// 45 R$ (Legendaries) 11
		{3605288831}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605288757,
		PBSpins5 = 3605288761,
		PBSpins10 = 3605288766,
		AshGreninja = 3605288769,
		Hoverboard = 3605288775,
		MasterBall = 3605288777,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
