...
assets.productId = {
		Starter =  3605210449,               --// 15 R$
		TenBP = 3605210451,                 --// 10 R$
		FiftyBP = 3605210454,               --// 30 R$
		TwoHundredBP = 3605210455,          --// 75 R$
		TwoThousandBP = 3605210459,         --// 200 R$
		UMV1 =  3605210464,                  --// 5 R$
		UMV3 = 3605210466,                  --// 10 R$
		UMV6 = 3605210468,                  --// 15 R$
		_10kP  = 3605210472,                --// 10 R$
		_50kP  = 3605210475,                --// 40 R$
		_100kP = 3605210480,                --// 75 R$
		_200kP = 3605210489,                --// 120 R$
		PBSpins1 = 3605210495,              --// 5 R$
		PBSpins5 = 3605210498,              --// 20 R$
		PBSpins10 = 3605210500,             --// 30 R$
		AshGreninja = 3605210501,           --// 75 R$
	Hoverboard = 3605210505,            --// 10 R$
	MasterBall = 3605210508,            --// 10 R$
	RoPowers = {
		{3605210513, 3605210516},       --// 15 R$, 20 R$ (XP) 1-2
		{3605210521, 3605210525},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605210530, 3605210532},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605210534, 3605210536},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605210540},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605210546},                     --// 45 R$ (Legendaries) 11
		{3605210548}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
