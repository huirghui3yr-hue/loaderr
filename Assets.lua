...
assets.productId = {
		Starter =  3605289363,               --// 15 R$
		TenBP = 3605289366,                 --// 10 R$
		FiftyBP = 3605289367,               --// 30 R$
		TwoHundredBP = 3605289369,          --// 75 R$
		TwoThousandBP = 3605289373,         --// 200 R$
		UMV1 =  3605289380,                  --// 5 R$
		UMV3 = 3605289385,                  --// 10 R$
		UMV6 = 3605289387,                  --// 15 R$
		_10kP  = 3605289390,                --// 10 R$
		_50kP  = 3605289392,                --// 40 R$
		_100kP = 3605289397,                --// 75 R$
		_200kP = 3605289400,                --// 120 R$
		PBSpins1 = 3605289406,              --// 5 R$
		PBSpins5 = 3605289414,              --// 20 R$
		PBSpins10 = 3605289417,             --// 30 R$
		AshGreninja = 3605289422,           --// 75 R$
	Hoverboard = 3605289428,            --// 10 R$
	MasterBall = 3605289431,            --// 10 R$
	RoPowers = {
		{3605289434, 3605289438},       --// 15 R$, 20 R$ (XP) 1-2
		{3605289444, 3605289446},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605289452, 3605289454},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605289457, 3605289459},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605289462},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605289468},                     --// 45 R$ (Legendaries) 11
		{3605289470}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605289406,
		PBSpins5 = 3605289414,
		PBSpins10 = 3605289417,
		AshGreninja = 3605289422,
		Hoverboard = 3605289428,
		MasterBall = 3605289431,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
