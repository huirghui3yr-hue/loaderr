...
assets.productId = {
		Starter =  3605281746,               --// 15 R$
		TenBP = 3605281753,                 --// 10 R$
		FiftyBP = 3605281758,               --// 30 R$
		TwoHundredBP = 3605281762,          --// 75 R$
		TwoThousandBP = 3605281767,         --// 200 R$
		UMV1 =  3605281772,                  --// 5 R$
		UMV3 = 3605281776,                  --// 10 R$
		UMV6 = 3605281779,                  --// 15 R$
		_10kP  = 3605281782,                --// 10 R$
		_50kP  = 3605281787,                --// 40 R$
		_100kP = 3605281796,                --// 75 R$
		_200kP = 3605281798,                --// 120 R$
		PBSpins1 = 3605281801,              --// 5 R$
		PBSpins5 = 3605281803,              --// 20 R$
		PBSpins10 = 3605281810,             --// 30 R$
		AshGreninja = 3605281814,           --// 75 R$
	Hoverboard = 3605281817,            --// 10 R$
	MasterBall = 3605281821,            --// 10 R$
	RoPowers = {
		{3605281826, 3605281832},       --// 15 R$, 20 R$ (XP) 1-2
		{3605281837, 3605281841},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605281844, 3605281847},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605281849, 3605281852},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605281857},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605281860},                     --// 45 R$ (Legendaries) 11
		{3605281861}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605281801,
		PBSpins5 = 3605281803,
		PBSpins10 = 3605281810,
		AshGreninja = 3605281814,
		Hoverboard = 3605281817,
		MasterBall = 3605281821,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
