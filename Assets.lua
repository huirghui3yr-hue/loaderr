...
assets.productId = {
		Starter =  3605272054,               --// 15 R$
		TenBP = 3605272056,                 --// 10 R$
		FiftyBP = 3605272060,               --// 30 R$
		TwoHundredBP = 3605272062,          --// 75 R$
		TwoThousandBP = 3605272063,         --// 200 R$
		UMV1 =  3605272069,                  --// 5 R$
		UMV3 = 3605272077,                  --// 10 R$
		UMV6 = 3605272085,                  --// 15 R$
		_10kP  = 3605272087,                --// 10 R$
		_50kP  = 3605272092,                --// 40 R$
		_100kP = 3605272096,                --// 75 R$
		_200kP = 3605272102,                --// 120 R$
		PBSpins1 = 3605272105,              --// 5 R$
		PBSpins5 = 3605272107,              --// 20 R$
		PBSpins10 = 3605272113,             --// 30 R$
		AshGreninja = 3605272115,           --// 75 R$
	Hoverboard = 3605272120,            --// 10 R$
	MasterBall = 3605272124,            --// 10 R$
	RoPowers = {
		{3605272127, 3605272131},       --// 15 R$, 20 R$ (XP) 1-2
		{3605272133, 3605272136},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605272139, 3605272144},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605272149, 3605272153},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605272155},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605272159},                     --// 45 R$ (Legendaries) 11
		{3605272163}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605272105,
		PBSpins5 = 3605272107,
		PBSpins10 = 3605272113,
		AshGreninja = 3605272115,
		Hoverboard = 3605272120,
		MasterBall = 3605272124,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
