...
assets.productId = {
		Starter =  3605279233,               --// 15 R$
		TenBP = 3605279236,                 --// 10 R$
		FiftyBP = 3605279240,               --// 30 R$
		TwoHundredBP = 3605279243,          --// 75 R$
		TwoThousandBP = 3605279250,         --// 200 R$
		UMV1 =  3605279258,                  --// 5 R$
		UMV3 = 3605279260,                  --// 10 R$
		UMV6 = 3605279268,                  --// 15 R$
		_10kP  = 3605279272,                --// 10 R$
		_50kP  = 3605279277,                --// 40 R$
		_100kP = 3605279283,                --// 75 R$
		_200kP = 3605279289,                --// 120 R$
		PBSpins1 = 3605279296,              --// 5 R$
		PBSpins5 = 3605279303,              --// 20 R$
		PBSpins10 = 3605279312,             --// 30 R$
		AshGreninja = 3605279319,           --// 75 R$
	Hoverboard = 3605279324,            --// 10 R$
	MasterBall = 3605279331,            --// 10 R$
	RoPowers = {
		{3605279339, 3605279344},       --// 15 R$, 20 R$ (XP) 1-2
		{3605279347, 3605279355},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605279361, 3605279368},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605279375, 3605279380},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605279386},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605279392},                     --// 45 R$ (Legendaries) 11
		{3605279398}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605279296,
		PBSpins5 = 3605279303,
		PBSpins10 = 3605279312,
		AshGreninja = 3605279319,
		Hoverboard = 3605279324,
		MasterBall = 3605279331,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
