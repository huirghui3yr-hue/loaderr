...
assets.productId = {
		Starter =  3605390110,               --// 15 R$
		TenBP = 3605390116,                 --// 10 R$
		FiftyBP = 3605390119,               --// 30 R$
		TwoHundredBP = 3605390123,          --// 75 R$
		TwoThousandBP = 3605390128,         --// 200 R$
		UMV1 =  3605390131,                  --// 5 R$
		UMV3 = 3605390133,                  --// 10 R$
		UMV6 = 3605390138,                  --// 15 R$
		_10kP  = 3605390145,                --// 10 R$
		_50kP  = 3605390149,                --// 40 R$
		_100kP = 3605390154,                --// 75 R$
		_200kP = 3605390160,                --// 120 R$
		PBSpins1 = 3605390163,              --// 5 R$
		PBSpins5 = 3605390168,              --// 20 R$
		PBSpins10 = 3605390171,             --// 30 R$
		AshGreninja = 3605390176,           --// 75 R$
	Hoverboard = 3605390178,            --// 10 R$
	MasterBall = 3605390180,            --// 10 R$
	RoPowers = {
		{3605390185, 3605390192},       --// 15 R$, 20 R$ (XP) 1-2
		{3605390197, 3605389868},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605389871, 3605390211},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605390215, 3605390219},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605390225},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605390232},                     --// 45 R$ (Legendaries) 11
		{3605390234}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605390163,
		PBSpins5 = 3605390168,
		PBSpins10 = 3605390171,
		AshGreninja = 3605390176,
		Hoverboard = 3605390178,
		MasterBall = 3605390180,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
