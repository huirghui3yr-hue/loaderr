...
assets.productId = {
		Starter =  3605264394,               --// 15 R$
		TenBP = 3605264397,                 --// 10 R$
		FiftyBP = 3605264400,               --// 30 R$
		TwoHundredBP = 3605264405,          --// 75 R$
		TwoThousandBP = 3605264410,         --// 200 R$
		UMV1 =  3605264413,                  --// 5 R$
		UMV3 = 3605264414,                  --// 10 R$
		UMV6 = 3605264417,                  --// 15 R$
		_10kP  = 3605264420,                --// 10 R$
		_50kP  = 3605264426,                --// 40 R$
		_100kP = 3605264430,                --// 75 R$
		_200kP = 3605264431,                --// 120 R$
		PBSpins1 = 3605264435,              --// 5 R$
		PBSpins5 = 3605264441,              --// 20 R$
		PBSpins10 = 3605264448,             --// 30 R$
		AshGreninja = 3605264454,           --// 75 R$
	Hoverboard = 3605264456,            --// 10 R$
	MasterBall = 3605264462,            --// 10 R$
	RoPowers = {
		{3605264464, 3605264471},       --// 15 R$, 20 R$ (XP) 1-2
		{3605264474, 3605264476},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605264478, 3605264480},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605264483, 3605264487},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605264492},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605264494},                     --// 45 R$ (Legendaries) 11
		{3605264496}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605264435,
		PBSpins5 = 3605264441,
		PBSpins10 = 3605264448,
		AshGreninja = 3605264454,
		Hoverboard = 3605264456,
		MasterBall = 3605264462,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
