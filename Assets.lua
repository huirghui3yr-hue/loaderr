...
assets.productId = {
		Starter =  3605283253,               --// 15 R$
		TenBP = 3605283258,                 --// 10 R$
		FiftyBP = 3605283264,               --// 30 R$
		TwoHundredBP = 3605283269,          --// 75 R$
		TwoThousandBP = 3605283275,         --// 200 R$
		UMV1 =  3605283282,                  --// 5 R$
		UMV3 = 3605283288,                  --// 10 R$
		UMV6 = 3605283297,                  --// 15 R$
		_10kP  = 3605283301,                --// 10 R$
		_50kP  = 3605283302,                --// 40 R$
		_100kP = 3605283305,                --// 75 R$
		_200kP = 3605283310,                --// 120 R$
		PBSpins1 = 3605283314,              --// 5 R$
		PBSpins5 = 3605283317,              --// 20 R$
		PBSpins10 = 3605283320,             --// 30 R$
		AshGreninja = 3605283325,           --// 75 R$
	Hoverboard = 3605283328,            --// 10 R$
	MasterBall = 3605283332,            --// 10 R$
	RoPowers = {
		{3605283336, 3605283341},       --// 15 R$, 20 R$ (XP) 1-2
		{3605283347, 3605283350},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605283357, 3605283362},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605283366, 3605283371},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605283374},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605283378},                     --// 45 R$ (Legendaries) 11
		{3605283381}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605283314,
		PBSpins5 = 3605283317,
		PBSpins10 = 3605283320,
		AshGreninja = 3605283325,
		Hoverboard = 3605283328,
		MasterBall = 3605283332,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
