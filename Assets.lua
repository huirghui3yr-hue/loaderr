...
assets.productId = {
		Starter =  3605284777,               --// 15 R$
		TenBP = 3605284781,                 --// 10 R$
		FiftyBP = 3605284786,               --// 30 R$
		TwoHundredBP = 3605284789,          --// 75 R$
		TwoThousandBP = 3605284795,         --// 200 R$
		UMV1 =  3605284798,                  --// 5 R$
		UMV3 = 3605284803,                  --// 10 R$
		UMV6 = 3605284805,                  --// 15 R$
		_10kP  = 3605284809,                --// 10 R$
		_50kP  = 3605284813,                --// 40 R$
		_100kP = 3605284816,                --// 75 R$
		_200kP = 3605284822,                --// 120 R$
		PBSpins1 = 3605284826,              --// 5 R$
		PBSpins5 = 3605284831,              --// 20 R$
		PBSpins10 = 3605284834,             --// 30 R$
		AshGreninja = 3605284838,           --// 75 R$
	Hoverboard = 3605284840,            --// 10 R$
	MasterBall = 3605284845,            --// 10 R$
	RoPowers = {
		{3605284847, 3605284851},       --// 15 R$, 20 R$ (XP) 1-2
		{3605284856, 3605284860},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605284862, 3605284867},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605284874, 3605284879},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605284883},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605284888},                     --// 45 R$ (Legendaries) 11
		{3605284892}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605284826,
		PBSpins5 = 3605284831,
		PBSpins10 = 3605284834,
		AshGreninja = 3605284838,
		Hoverboard = 3605284840,
		MasterBall = 3605284845,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
