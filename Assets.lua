...
assets.productId = {
		Starter =  3605282829,               --// 15 R$
		TenBP = 3605282835,                 --// 10 R$
		FiftyBP = 3605282841,               --// 30 R$
		TwoHundredBP = 3605282844,          --// 75 R$
		TwoThousandBP = 3605282847,         --// 200 R$
		UMV1 =  3605282853,                  --// 5 R$
		UMV3 = 3605282857,                  --// 10 R$
		UMV6 = 3605282862,                  --// 15 R$
		_10kP  = 3605282866,                --// 10 R$
		_50kP  = 3605282867,                --// 40 R$
		_100kP = 3605282871,                --// 75 R$
		_200kP = 3605282874,                --// 120 R$
		PBSpins1 = 3605282876,              --// 5 R$
		PBSpins5 = 3605282882,              --// 20 R$
		PBSpins10 = 3605282887,             --// 30 R$
		AshGreninja = 3605282892,           --// 75 R$
	Hoverboard = 3605282897,            --// 10 R$
	MasterBall = 3605282904,            --// 10 R$
	RoPowers = {
		{3605282906, 3605282910},       --// 15 R$, 20 R$ (XP) 1-2
		{3605282914, 3605282917},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605282918, 3605282924},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605282926, 3605282928},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605282931},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605282935},                     --// 45 R$ (Legendaries) 11
		{3605282938}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605282876,
		PBSpins5 = 3605282882,
		PBSpins10 = 3605282887,
		AshGreninja = 3605282892,
		Hoverboard = 3605282897,
		MasterBall = 3605282904,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
