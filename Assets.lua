...
assets.productId = {
		Starter =  3605268861,               --// 15 R$
		TenBP = 3605268864,                 --// 10 R$
		FiftyBP = 3605268869,               --// 30 R$
		TwoHundredBP = 3605268874,          --// 75 R$
		TwoThousandBP = 3605268879,         --// 200 R$
		UMV1 =  3605268885,                  --// 5 R$
		UMV3 = 3605268886,                  --// 10 R$
		UMV6 = 3605268889,                  --// 15 R$
		_10kP  = 3605268891,                --// 10 R$
		_50kP  = 3605268895,                --// 40 R$
		_100kP = 3605268898,                --// 75 R$
		_200kP = 3605268902,                --// 120 R$
		PBSpins1 = 3605268903,              --// 5 R$
		PBSpins5 = 3605268906,              --// 20 R$
		PBSpins10 = 3605268909,             --// 30 R$
		AshGreninja = 3605268913,           --// 75 R$
	Hoverboard = 3605268915,            --// 10 R$
	MasterBall = 3605268917,            --// 10 R$
	RoPowers = {
		{3605268918, 3605268923},       --// 15 R$, 20 R$ (XP) 1-2
		{3605268925, 3605268929},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605268932, 3605268934},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605268938, 3605268940},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605268942},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605268943},                     --// 45 R$ (Legendaries) 11
		{3605268947}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605268903,
		PBSpins5 = 3605268906,
		PBSpins10 = 3605268909,
		AshGreninja = 3605268913,
		Hoverboard = 3605268915,
		MasterBall = 3605268917,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
