...
assets.productId = {
		Starter =  3605262987,               --// 15 R$
		TenBP = 3605262992,                 --// 10 R$
		FiftyBP = 3605262999,               --// 30 R$
		TwoHundredBP = 3605263003,          --// 75 R$
		TwoThousandBP = 3605263010,         --// 200 R$
		UMV1 =  3605263012,                  --// 5 R$
		UMV3 = 3605263016,                  --// 10 R$
		UMV6 = 3605263019,                  --// 15 R$
		_10kP  = 3605263026,                --// 10 R$
		_50kP  = 3605263029,                --// 40 R$
		_100kP = 3605263030,                --// 75 R$
		_200kP = 3605263035,                --// 120 R$
		PBSpins1 = 3605263036,              --// 5 R$
		PBSpins5 = 3605263039,              --// 20 R$
		PBSpins10 = 3605263050,             --// 30 R$
		AshGreninja = 3605263056,           --// 75 R$
	Hoverboard = 3605263057,            --// 10 R$
	MasterBall = 3605263063,            --// 10 R$
	RoPowers = {
		{3605263065, 3605263068},       --// 15 R$, 20 R$ (XP) 1-2
		{3605263072, 3605263075},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605263078, 3605263082},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605263085, 3605263088},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605263089},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605263092},                     --// 45 R$ (Legendaries) 11
		{3605263097}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605263036,
		PBSpins5 = 3605263039,
		PBSpins10 = 3605263050,
		AshGreninja = 3605263056,
		Hoverboard = 3605263057,
		MasterBall = 3605263063,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
