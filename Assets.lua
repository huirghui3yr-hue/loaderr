...
assets.productId = {
		Starter =  3605392116,               --// 15 R$
		TenBP = 3605392119,                 --// 10 R$
		FiftyBP = 3605392126,               --// 30 R$
		TwoHundredBP = 3605392130,          --// 75 R$
		TwoThousandBP = 3605392137,         --// 200 R$
		UMV1 =  3605392143,                  --// 5 R$
		UMV3 = 3605392144,                  --// 10 R$
		UMV6 = 3605392147,                  --// 15 R$
		_10kP  = 3605392151,                --// 10 R$
		_50kP  = 3605392154,                --// 40 R$
		_100kP = 3605392157,                --// 75 R$
		_200kP = 3605392162,                --// 120 R$
		PBSpins1 = 3605392168,              --// 5 R$
		PBSpins5 = 3605392174,              --// 20 R$
		PBSpins10 = 3605392176,             --// 30 R$
		AshGreninja = 3605392179,           --// 75 R$
	Hoverboard = 3605392181,            --// 10 R$
	MasterBall = 3605392184,            --// 10 R$
	RoPowers = {
		{3605392185, 3605392189},       --// 15 R$, 20 R$ (XP) 1-2
		{3605392192, 3605392199},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605392204, 3605392208},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605392213, 3605392217},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605392224},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605392228},                     --// 45 R$ (Legendaries) 11
		{3605392231}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605392168,
		PBSpins5 = 3605392174,
		PBSpins10 = 3605392176,
		AshGreninja = 3605392179,
		Hoverboard = 3605392181,
		MasterBall = 3605392184,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
