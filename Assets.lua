...
assets.productId = {
		Starter =  3605266492,               --// 15 R$
		TenBP = 3605266495,                 --// 10 R$
		FiftyBP = 3605266499,               --// 30 R$
		TwoHundredBP = 3605266503,          --// 75 R$
		TwoThousandBP = 3605266508,         --// 200 R$
		UMV1 =  3605266510,                  --// 5 R$
		UMV3 = 3605266514,                  --// 10 R$
		UMV6 = 3605266516,                  --// 15 R$
		_10kP  = 3605266518,                --// 10 R$
		_50kP  = 3605266521,                --// 40 R$
		_100kP = 3605266524,                --// 75 R$
		_200kP = 3605266527,                --// 120 R$
		PBSpins1 = 3605266531,              --// 5 R$
		PBSpins5 = 3605266535,              --// 20 R$
		PBSpins10 = 3605266540,             --// 30 R$
		AshGreninja = 3605266541,           --// 75 R$
	Hoverboard = 3605266547,            --// 10 R$
	MasterBall = 3605266550,            --// 10 R$
	RoPowers = {
		{3605266552, 3605266553},       --// 15 R$, 20 R$ (XP) 1-2
		{3605266558, 3605266563},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605266569, 3605266571},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605266573, 3605266575},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605266578},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605266585},                     --// 45 R$ (Legendaries) 11
		{3605266589}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605266531,
		PBSpins5 = 3605266535,
		PBSpins10 = 3605266540,
		AshGreninja = 3605266541,
		Hoverboard = 3605266547,
		MasterBall = 3605266550,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
