...
assets.productId = {
		Starter =  3605276608,               --// 15 R$
		TenBP = 3605276612,                 --// 10 R$
		FiftyBP = 3605276617,               --// 30 R$
		TwoHundredBP = 3605276623,          --// 75 R$
		TwoThousandBP = 3605276625,         --// 200 R$
		UMV1 =  3605276630,                  --// 5 R$
		UMV3 = 3605276634,                  --// 10 R$
		UMV6 = 3605276638,                  --// 15 R$
		_10kP  = 3605276644,                --// 10 R$
		_50kP  = 3605276646,                --// 40 R$
		_100kP = 3605276654,                --// 75 R$
		_200kP = 3605276659,                --// 120 R$
		PBSpins1 = 3605276661,              --// 5 R$
		PBSpins5 = 3605276664,              --// 20 R$
		PBSpins10 = 3605276670,             --// 30 R$
		AshGreninja = 3605276672,           --// 75 R$
	Hoverboard = 3605276676,            --// 10 R$
	MasterBall = 3605276684,            --// 10 R$
	RoPowers = {
		{3605276690, 3605276696},       --// 15 R$, 20 R$ (XP) 1-2
		{3605276701, 3605276707},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605276711, 3605276721},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605276728, 3605276731},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605276737},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605276742},                     --// 45 R$ (Legendaries) 11
		{3605276747}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605276661,
		PBSpins5 = 3605276664,
		PBSpins10 = 3605276670,
		AshGreninja = 3605276672,
		Hoverboard = 3605276676,
		MasterBall = 3605276684,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
