...
assets.productId = {
		Starter =  3605269640,               --// 15 R$
		TenBP = 3605269644,                 --// 10 R$
		FiftyBP = 3605269646,               --// 30 R$
		TwoHundredBP = 3605269649,          --// 75 R$
		TwoThousandBP = 3605269654,         --// 200 R$
		UMV1 =  3605269659,                  --// 5 R$
		UMV3 = 3605269662,                  --// 10 R$
		UMV6 = 3605269665,                  --// 15 R$
		_10kP  = 3605269668,                --// 10 R$
		_50kP  = 3605269673,                --// 40 R$
		_100kP = 3605269675,                --// 75 R$
		_200kP = 3605269680,                --// 120 R$
		PBSpins1 = 3605269686,              --// 5 R$
		PBSpins5 = 3605269688,              --// 20 R$
		PBSpins10 = 3605269689,             --// 30 R$
		AshGreninja = 3605269693,           --// 75 R$
	Hoverboard = 3605269698,            --// 10 R$
	MasterBall = 3605269699,            --// 10 R$
	RoPowers = {
		{3605269701, 3605269704},       --// 15 R$, 20 R$ (XP) 1-2
		{3605269708, 3605269714},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605269718, 3605269719},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605269720, 3605269725},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605269729},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605269731},                     --// 45 R$ (Legendaries) 11
		{3605269734}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605269686,
		PBSpins5 = 3605269688,
		PBSpins10 = 3605269689,
		AshGreninja = 3605269693,
		Hoverboard = 3605269698,
		MasterBall = 3605269699,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
