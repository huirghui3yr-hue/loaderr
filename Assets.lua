...
assets.productId = {
		Starter =  3605212170,               --// 15 R$
		TenBP = 3605212172,                 --// 10 R$
		FiftyBP = 3605212173,               --// 30 R$
		TwoHundredBP = 3605212176,          --// 75 R$
		TwoThousandBP = 3605212178,         --// 200 R$
		UMV1 =  3605212181,                  --// 5 R$
		UMV3 = 3605212185,                  --// 10 R$
		UMV6 = 3605212186,                  --// 15 R$
		_10kP  = 3605212187,                --// 10 R$
		_50kP  = 3605212190,                --// 40 R$
		_100kP = 3605212193,                --// 75 R$
		_200kP = 3605212196,                --// 120 R$
		PBSpins1 = 3605212198,              --// 5 R$
		PBSpins5 = 3605212200,              --// 20 R$
		PBSpins10 = 3605212204,             --// 30 R$
		AshGreninja = 3605212209,           --// 75 R$
	Hoverboard = 3605212212,            --// 10 R$
	MasterBall = 3605212214,            --// 10 R$
	RoPowers = {
		{3605212215, 3605212218},       --// 15 R$, 20 R$ (XP) 1-2
		{3605212223, 3605212226},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605212229, 3605212230},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605212234, 3605212236},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605212240},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605212241},                     --// 45 R$ (Legendaries) 11
		{3605212244}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
