...
assets.productId = {
		Starter =  3605389790,               --// 15 R$
		TenBP = 3605389793,                 --// 10 R$
		FiftyBP = 3605389795,               --// 30 R$
		TwoHundredBP = 3605389799,          --// 75 R$
		TwoThousandBP = 3605389803,         --// 200 R$
		UMV1 =  3605389807,                  --// 5 R$
		UMV3 = 3605389811,                  --// 10 R$
		UMV6 = 3605389812,                  --// 15 R$
		_10kP  = 3605389819,                --// 10 R$
		_50kP  = 3605389824,                --// 40 R$
		_100kP = 3605389826,                --// 75 R$
		_200kP = 3605389830,                --// 120 R$
		PBSpins1 = 3605389833,              --// 5 R$
		PBSpins5 = 3605389837,              --// 20 R$
		PBSpins10 = 3605389842,             --// 30 R$
		AshGreninja = 3605389849,           --// 75 R$
	Hoverboard = 3605389852,            --// 10 R$
	MasterBall = 3605389858,            --// 10 R$
	RoPowers = {
		{3605389860, 3605389863},       --// 15 R$, 20 R$ (XP) 1-2
		{3605389865, 3605389868},       --// 15 R$, 20 R$ (Hatching) 3-4
		{3605389871, 3605389876},       --// 20 R$, 35 R$ (Pokedollars) 5-6
		{3605389879, 3605389881},       --// 15 R$, 20 R$ (EVs) 7-8
		{3605389886},                   --// 30 R$ (Shiny Boost) 9
		{},                             --// 0  R$ (DO NOT USE) 10
		{3605389890},                     --// 45 R$ (Legendaries) 11
		{3605389891}                     --// 30 R$ Hidden Ability 12
	},
}
assets.passId = {
	ExpShare = 17791149,
...
--		dialgaLand = 509536981,
	...
	assets.productId = {
		...
		PBSpins1 = 3605389833,
		PBSpins5 = 3605389837,
		PBSpins10 = 3605389842,
		AshGreninja = 3605389849,
		Hoverboard = 3605389852,
		MasterBall = 3605389858,
		RoPowers = {
			{ 31193154, 31193159 },
			{ 31193165, 31193169 },
			{ 31193187, 31193191 },
