...
assets.productId = {
		...
		UMV1 =  3605122148,                  --// 5 R$
		UMV3 = 3605122151,                  --// 10 R$
		UMV6 = 3605122153,                  --// 15 R$
		_10kP  = 3299078476,                --// 10 R$
		_50kP  = 3299078623,                --// 40 R$
		_100kP = 3299078733,                --// 75 R$
		_200kP = 3299078860,                --// 120 R$
		PBSpins1 = 3605122156,              --// 5 R$
		PBSpins5 = 3605122159,              --// 20 R$
		PBSpins10 = 3605122163,             --// 30 R$
		AshGreninja = 3295492131,           --// 75 R$
	Hoverboard = 3605122168,            --// 10 R$
	MasterBall = 3605122174,            --// 10 R$
	RoPowers = {
